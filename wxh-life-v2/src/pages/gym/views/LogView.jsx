...
export default function LogView({ entries, custom, onDelete, onUpdate }) {
  ...
  return (
    <section className="animate-in">
      ...
      {editing && <EditEntryModal entry={editing} custom={custom} onClose={() => setEditing(null)} onSave={(next) => { onUpdate(next); setEditing(null); }} />}
    </section>
  );
}
